...
cmake .. -DTENSORRT_ROOT=/usr/include/aarch64-linux-gnu/ -DCUDNN_INCLUDE_DIR=/usr/local/cuda-10.0/include/ -DCUBLAS_LIBRARY=/usr/local/cuda-10.0/lib64/libcublas.so 
make -j12
sudo make install
